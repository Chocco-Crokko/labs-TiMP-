...
void comparing_files(FILE *file1, FILE *file2)
{
	...
	{
		check = 0;
		if (strstr(str1, "\n")) str1[strlen(str1) - 1] = '\0';	// убираем символ перехода на новую строку из строк
...
int main(int argc, char* argv[])
{
	...
	if (!err) {
		printf("***File 1***\n");
		// сравниваем строки из первого файла со строками из второго
		// если не найдено совпадение, то выводим эту уникальную строку и её номер
		comparing_files(file1, file2);
		printf("***File 2***\n");
		// то же самое, но сравнение строк второго файла с первым
